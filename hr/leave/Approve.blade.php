...
<div class="modal fade"  id="ApproveLeave{{ $data->id }}">
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title">Approve the leave request for the staff member
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('ApproveLeave') }}" class="row" method="POST">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger" >Approve Leave</button>
