    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title">Attach new scanned document to the contractor
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('NewConDoc') }}" class="row" method="POST" enctype="multipart/form-data"> @csrf <div
                    class="row">
        ...
        <input type="hidden" name="Designation" value="{{$E->Expertise}}">

        <input type="hidden" name="StaffName" value="{{$E->StaffName}}">

        <input type="hidden" name="DOCID" value="{{\Hash::make($E->EmpID)}}">
