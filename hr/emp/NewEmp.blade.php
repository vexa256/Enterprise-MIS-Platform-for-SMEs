    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('NewEmp') }}" class="row" method="POST" enctype=multipart/form-data> @csrf <div
                    class="row">
                    ...
                    <div class="mb-3 mt-3 col-md-3" >
                        ...
                        <select name="Gender" required class="form-select form-control-sm  form-control" data-control="select2" data-placeholder="Select an option">
                            <option></option>
                    ...
                    <div class="mb-3 mt-3 col-md-3" >
                        ...
                        <select name="Designation" required class="form-select form-control-sm  form-control" data-control="select2" data-placeholder="Select an option">
                            <option></option>
                           @isset($Roles)
