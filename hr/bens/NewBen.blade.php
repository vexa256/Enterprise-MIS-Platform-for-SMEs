    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title">Create a new non salary benefit category | Amount is in UGX

                   <small class="text-danger">  Please attach applicable pdf uploads to staff documentation |  Photo attachments supported</small>
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('NewBenCat') }}" class="row" method="POST" enctype=multipart/form-data> @csrf <div
                    class="row">
