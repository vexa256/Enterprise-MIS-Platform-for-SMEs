    ...
    <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header bg-gray">
                <h5 class="modal-title">Create new salary tax category
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('NewTax') }}" class="row" method="POST" enctype=multipart/form-data> @csrf <div
                    class="row">
            ...
            {!! Form::hidden($name="TID", $value=\Hash::make(uniqid()."AFC".date('Y-m-d H:I:S')), [$options=null]) !!}
